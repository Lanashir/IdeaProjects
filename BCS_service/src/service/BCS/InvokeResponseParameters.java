...
public class InvokeResponseParameters {
    ...
    protected List<AdditionalParameters> additionalParams;
     ...
     * 
     */
    public List<AdditionalParameters> getAdditionalParams() {
        if (additionalParams == null) {
            additionalParams = new ArrayList<AdditionalParameters>();
        }
